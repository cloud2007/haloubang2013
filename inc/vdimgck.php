...
if (!echo_validate_image($config))
{
    ...
    $im = @imagecreatefromjpeg(dirname(__FILE__).'/lib/words/vdcode.jpg');
...
function echo_validate_image( $config = array() )
{
    ...
    $font_file   = isset($config['font_file']) ? $config['font_file'] : dirname(__FILE__).'/lib/fonts/ggbi.ttf';
