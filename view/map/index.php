...
<div id="main1">
	<div class="left">
		...
		<div class="nav">
			<div class="tit">月租金:<font style="font-weight:normal; color:#666">(元/平米·月)</font></div>
			<ul>
				<li><a class="rz <?php if($_GET['rz']=="0,0" || $_GET['rz']=="") echo "hover";?>" href="javascript:void(0);" rel="0,0">不限</a></li>
				<li><a class="rz <?php if($_GET['rz']=="0,30") echo "hover";?>" href="javascript:void(0);" rel="0,30">30元以下</a></li>
				<li><a class="rz <?php if($_GET['rz']=="30,60") echo "hover";?>" href="javascript:void(0);" rel="30,60">30-60元</a></li>
				<li><a class="rz <?php if($_GET['rz']=="60,90") echo "hover";?>" href="javascript:void(0);" rel="60,90">60-90元</a></li>
				<li><a class="rz <?php if($_GET['rz']=="90,120") echo "hover";?>" href="javascript:void(0);" rel="90,120">90-120元</a></li>
				<li><a class="rz <?php if($_GET['rz']=="120,150") echo "hover";?>" href="javascript:void(0);" rel="120,150">120-150元</a></li>
				<li><a class="rz <?php if($_GET['rz']=="150,10000") echo "hover";?>" href="javascript:void(0);" rel="150,10000">150元以上</a></li>
			</ul>
			<div class="clear"></div>
		</div>
		<div class="nav">
			<div class="tit">总租金:<font style="font-weight:normal; color:#666">(元/月)</font></div>
			<ul>
				<li><a class="yz <?php if($_GET['yz']=="0,0" || $_GET['yz']=="") echo "hover";?>" href="javascript:void(0);" rel="0,0">不限</a></li>
				<li><a class="yz <?php if($_GET['yz']=="0,5000") echo "hover";?>" href="javascript:void(0);" rel="0,5000">5000元以下</a></li>
				<li><a class="yz <?php if($_GET['yz']=="5000,10000") echo "hover";?>" href="javascript:void(0);" rel="5000,10000">5000-1万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="10000,20000") echo "hover";?>" href="javascript:void(0);" rel="10000,20000">1-2万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="20000,30000") echo "hover";?>" href="javascript:void(0);" rel="20000,30000">2-3万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="30000,50000") echo "hover";?>" href="javascript:void(0);" rel="30000,50000">3-5万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="50000,70000") echo "hover";?>" href="javascript:void(0);" rel="50000,70000">5-7万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="70000,100000") echo "hover";?>" href="javascript:void(0);" rel="70000,100000">7-10万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="100000,200000") echo "hover";?>" href="javascript:void(0);" rel="100000,200000">10-20万</a></li>
				<li><a class="yz <?php if($_GET['yz']=="200000,10000000") echo "hover";?>" href="javascript:void(0);" rel="200000,10000000">20万以上</a></li>
			</ul>
			<div class="clear"></div>
		</div>
	</div>
...
foreach($result as $k => $v){
	...
	if($_GET['yz']<>"0,0" && $_GET['yz']<>""){
		$yz=explode(',',$_GET['yz']);
		$whereand_house[]=array('type','=1 and area*price>'.$yz[0].' and area*price<'.$yz[1]);
	}
