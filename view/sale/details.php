<div class="content">
	...
	<div id="houses">
		...
		<div class="houses_r h_information"> <span class="house_title">房源基本概况<font color="#CCCCCC" style="font-size:12px; padding-left:10px; font-weight:100">最后发布时间：<?php echo $house->editTime();?></font></span>
			<ul class="houses_des">
				<li><span class="f"><span >楼盘：</span><span class="t"><a href="/borough/d-<?php echo $borough->id;?>.html"><?php echo $borough->b_name;?></a><font style="font-size:12px; display:none;">【<?php echo Config::item('area_'.$borough->b_area1.'.'.$borough->b_area2);?>】</font></span></span>  </li>
				<li><span class="f"><span class="f1">单价：</span><span class="r"><?php echo $house->price;?></span> 元/平米 </span> <span class="f1">售价：</span><span class="r"><?php echo number_format($house -> area * $house -> price /10000 , 2) ;?>万元</span></li>
				<li><span class="f"><span class="f1">楼层：</span><span class="r"><?php echo $house->h_floor;?>层</span>/<?php echo $borough->get('zonglouceng');?>层</span> 
                <span class="f1">面积：</span><span class="r"><?php echo $house->area;?>平方米</span>
...
<li  ><span ><span>地址：</span><span style="color:#000" > <?php echo $borough->b_addr;?> 【<a href="#map_a" style="color:#00f;">地图</a>】 </span></span> </span></li>
<li><span class="f"><span>楼盘均价：</span><span style="color:#000" ><?php echo $borough->b_saletprice1.'-'.$borough->b_saletprice2;?>元/平米</span></span>
<span>楼盘类型：</span><span style="color:#000"><?php echo Config::item('borough_level.'.$borough->b_level);?></span>
</li>
</ul>
		</div>
	</div>
	<div id="house_information">
        ...
        <a class="one"  href="#h_Availability">房源介绍</a> <a href="#photo_pb_box">房源照片</a> <a href="#parameter">楼盘参数</a> <a href="#map_a">楼盘地图</a> <a href="#Real_photo">楼盘相册</a>
			...
			<div id="h_Availability">
				...
				<p align="center"><?php if(Config::item('borough_pictype.'.$value->pic_sub_cate))echo Config::item('borough_pictype.'.$value->pic_sub_cate); else echo "房源图片";?></p>
                <?php }?>
				</div>
			...
			<div class="mark h2">
				...
				<div class="mark_bg h3">
					...
					<ul>
						...
						<li><a href="/sale/d-<?php echo $value->id;?>.html">
						
							
						<dl style="width:80px;float:left;"><?php echo $value->roomnum;?>号</dl>
						<dl style="width:60px;float:left;"><?php echo $value->area;?>平米 </dl>
						<dl style="width:90px;float:left;"><?php echo $value->price;?>元/平米•月</dl>
    ...
    overflow: hidden;
    width: 105px; " href="/rent/d-<?php echo $v->id;?>.html"><?php echo $v->b_name.$v->roomnum.'号';?></a>
                              <a style="float:right; color:#00f" href="/rent/d-<?php echo $v->id;?>.html">【<?php echo Config::item('area_'.$v->b_area1.'.'.$v->b_area2);?>】</a>          
										...
										<dd <?php if($k>0)echo 'style="display:none"';?>><a href="/rent/d-<?php echo $v->id;?>.html"><img src="<?php echo Util::getpicthumb($v -> getdefaultpic(),'small') ;?>" width="79" height="64" alt=""></a>
											...
											<p style="float:left;width:70px"><a href="/rent/d-<?php echo $v->id;?>.html"  class="red"><?php echo $v->price;?>元/平米</a></p> <p style=" float:right; width:50px"><a href="/rent/d-<?php echo $v->id;?>.html"  class="red"><?php echo $house->area;?>平米</a></p>
										</dd>
									</dl>
								</li>
								<?php }?>
    ...
    overflow: hidden;
    width: 105px; " href="/rent/d-<?php echo $v->id;?>.html"><?php echo $v->b_name.$v->roomnum.'号';?></a>
                              <a style="float:right; color:#00f" href="/sale/d-<?php echo $v->id;?>.html">【<?php echo Config::item('area_'.$v->b_area1.'.'.$v->b_area2);?>】</a>          
										...
										<dd <?php if($kk>0)echo 'style="display:none"';?>><a href="/rent/d-<?php echo $v->id;?>.html"><img src="<?php echo Util::getpicthumb($v -> getdefaultpic(),'small') ;?>" width="79" height="64" alt=""></a>
											...
											<p style="float:left;width:70px"><a href="/sale/d-<?php echo $v->id;?>.html"  class="red"><?php echo $v->price;?>元/平米</a></p> <p style=" float:right; width:50px"><a href="/rent/d-<?php echo $v->id;?>.html"  class="red"><?php echo $house->area;?>平米</a></p>
										</dd>
									</dl>
								</li>
								<?php }?>
	...
	<div class="map_a Real_photo" id="Real_photo">
		<div class="map_title">
			...
			<span><a href="/photo/details.php?id=<?php echo $v->id;?>">楼盘相册</a></span><!--a href="#">楼盘照片（21）</a><a href="#">周边照片（8）</a><a href="#">平面图（21）</a--></div>
		<div class="r_p">
			<ul>
				<?php foreach($borough_pic as $v){?>
				<li><a href="<?php echo $value->pic_thumb;?>" target="_blank"><img src="<?php echo Util::getpicthumb($v->pic_thumb,'thumb');?>" width="100" height="75" alt=""></a></li>
				<?php }?>
			</ul>
		</div>
	</div>
...
<div class="Floating"><div class="floating_box">租金：<?php echo $house->price;?>元/平方&nbsp;&nbsp;&nbsp;&nbsp;面积：<?php echo $house->area;?>平方米&nbsp;&nbsp;&nbsp;&nbsp;楼盘：<?php echo $borough->b_name;?>【<?php echo Config::item('area_'.$borough->b_area1.'.'.$borough->b_area2);?>】&nbsp;&nbsp;&nbsp;&nbsp; 经纪人：<?php echo $borker->uname;?>&nbsp;&nbsp;&nbsp;<font color="#FFFF00"><?php echo $borker->get('tel');?></font>
</div>
</div>