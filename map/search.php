...
if($zujin){
	$zujin=explode(',',$zujin);
	$whereand[]=array('type','=1 and price*area>'.$zujin[0].' and price*area<'.$zujin[1]);
}
		...
		<li>
			<table width="400" border="0" cellpadding="0" cellspacing="0">
				<tr>
					...
					<td width="230" style="line-height:22px"><a href="/rent/d-<?php echo $row['id'];?>.html" target="_blank"><?php echo $v->b_name;?></a><br /><?php echo $v->area;?>平米 第<?php echo $v->h_floor;?>/<?php echo $v->b_floor;?>层 <?php echo $v->price;?>元/平米·月</td>
					<td width="89" align="center" style="color:#FF6600; font-weight:bold;"><?php echo $v->area*$v->price;?>元/月</td>
				</tr>
			</table>
		</li>
		<?php
