...
if($_GET['price']) $whereand[]=array('price',$price[$_GET['price']]);
...
$postion = '<a href="/">首页</a> > <a href="/rent">出租房源</a>';
...
if($_GET['is_present']==1) $t1 .= '租房有礼';

$view -> set('web_title','成都'.$t.'写字楼出租 '.$t1.' - 好楼帮');
$view -> set('web_keywords','成都写字楼出租,写字间出租,'.$t.'办公楼出租');
$view -> set('web_description','找成都'.$t.'写字楼出租就到好楼帮，'.$t1.'写字间出租信息量更多。我们致力于成都写字楼出租行业，为商家提供最具价值的的写字楼出租信息。');
